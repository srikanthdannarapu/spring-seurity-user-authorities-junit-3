...
public class CustomerControllerIT extends BaseIT {
    ...
    class ListCustomers {
        ...
        @MethodSource("com.srikanth.brewery.web.controllers.BeerControllerIT#getStreamAdminCustomer")
        ...
        @ParameterizedTest(name = "#{index} with [{arguments}]")
        @MethodSource("com.srikanth.brewery.web.controllers.BeerControllerIT#getStreamNoAuthCustomers")
        void testListCustomersNOTAUTH(String user, String pwd) throws Exception {
            mockMvc.perform(get("/customers")
    ...
    class AddCustomers {
        ...
        @Rollback
        @ParameterizedTest(name = "#{index} with [{arguments}]")
        @MethodSource("com.srikanth.brewery.web.controllers.BeerControllerIT#getStreamNotAdmin")
